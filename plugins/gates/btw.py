...
def panel(_, message):
    ...
    if '<b>ingrese la ccs.</b>' in cc:
        return message.reply('<b>Command: <code>$btw</code>\nGateway: <code>Braintre AUTH</code>\nEstado: <code>✅</code>\nFormat: <code>/btw cc|month|year|cvv.</code></b>')
