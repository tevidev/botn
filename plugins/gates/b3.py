...
from pages.bulkmemorycards import BraintreeAuthWoo
...
""")
    ...
    if '<b>ingrese la ccs.</b>' in cc:
        return message.reply(f"""<b>Command: <code>$b3</code>\nGateway: <code>Braintree Auth</code>\nEstado: <code>✅</code>\nFormat: <code>/b3 cc|month|year|cvv.</code></b>
""")
